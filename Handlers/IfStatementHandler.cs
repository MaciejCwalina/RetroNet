namespace RetroNet.Handlers
{
    ...
    public class IfStatementHandler
    {
        ...
        public void CreateIfStatement(Int32 index)
        {
            index++;
            Int32 secondaryIndex = index++;
            IfStatment thisStatement = new IfStatement{};
            thisStatement.conditions = new List<Token>();
            while (this._token[secondaryIndex].etoken != token.etoken.RPAR)
            {
            ...
            {
                thisStatement.body.Add(this._token[secondaryIndex]);
                secondaryIndex++;
            }
        }
